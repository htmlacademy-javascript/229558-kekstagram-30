import {getRandomNumberFromRangeGenerator, getSerialNumberGenerator} from './util.js'; // все задаваемые данные и шаблоны


/// Входные данные, задаваемые "пользователем" вручную.
